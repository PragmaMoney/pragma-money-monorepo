...
export const servicesSchema = {
  ...
  description:
    "Browse, search, and register services on the PragmaMoney ServiceRegistry (Monad Testnet). List all services, get details, search, or register a new service on-chain.",
  input_schema: {
