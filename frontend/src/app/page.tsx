      ...
      <div className="px-6 py-20 lg:p-24 selection:bg-pragma-primary selection:text-white">
        ...
        <section className="mb-40">
          ...
          <div className="space-y-0">
            {[
              ...
              { id: "03", title: "Monad Testnet", desc: "Fast, cheap transactions with native x402 support on Monad Testnet." }
            ].map((item) => (
        ...
        <section className="mb-40">
          ...
          <div className="grid gap-12">
            {[
              { step: "01", label: "REGISTER", text: "Set price per call. Deploy to ServiceRegistry on Monad Testnet." },
